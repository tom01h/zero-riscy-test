  ...
  while(fgets(str, sizeof(str), fd)){
    ...
    if(rtype==0 &&
      ...
      for(i=0; i<bytec/4; i = i+1){
        ...
        if(base&0x100000){
          verilator_top->v__DOT__DUT__DOT__zeroriscy_d_sram__DOT__mem[((base%0x40000)+addr)/4+i] =
  ...
  while (!Verilated::gotFinish()) {
    ...
    if((verilator_top->v__DOT__sd_sim__DOT__req_l)&
      ...
      for(lb=0; lb<verilator_top->v__DOT__sd_sim__DOT__d_l; lb++){
        tmp=verilator_top->v__DOT__DUT__DOT__zeroriscy_d_sram__DOT__mem[(buffpointer+lb)/4];
        ...
        verilator_top->v__DOT__DUT__DOT__zeroriscy_d_sram__DOT__mem[(buffpointer+lb)/4]=tmp;
      }
      verilator_top->v__DOT__DUT__DOT__zeroriscy_d_sram__DOT__mem[sizepointer/4]=lb;
    }
