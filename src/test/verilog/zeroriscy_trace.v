         ...
         if(instr[14:12]==2 && instr[6:2]==5'h00 && instr[1:0]==3)
           $fwrite(F_HANDLE," : lw       x%02d x%02d<=(%08x)", rs1, rd, rs1d+imm12);
         ...
         if(instr[14:12]==2 && instr[6:2]==5'h08 && instr[1:0]==3)
           $fwrite(F_HANDLE," : sw       x%02d x%02d (%08x)<=%08x", rs1, rs2, rs1d+immhl, rs2d);
